...
% ------------------------------------------------------------
\begin{document}
\title{A New Look to an Old problem: Predictive
Normalized Likelihood for Least Squares} 
...
% exp\left\{-\frac{1}{2\sigma^2}\left((1-x^T P_N x)y-\hat{y} + x^T P_N x\hat{y} \right)^2\right\}  \\
% =\frac{1}{\sqrt[]{2\pi\sigma^2}}
