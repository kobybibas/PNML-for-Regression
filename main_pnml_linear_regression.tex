...
% learning field, the least squares estimator is used for prediction in both ERM and Bayesian approaches \cite{fornalski2015applications}. 
...
%% formatting style!):
\bibliographystyle{IEEEtran}
\bibliography{main_pnml_linear_regression}
